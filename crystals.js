...
class CrystalLayer {
  constructor() {
      ...
      this.thinStroke = 1
      this.thickStroke = 3
      this.layerColor = getRandFromPalette()
  };
}

class Circles extends CrystalLayer {
  constructor(){
    super()
...
class SimpleLines extends CrystalLayer {
  constructor() {
    super()
...
class OutlineShape extends CrystalLayer {
  constructor() {
    super()
    this.weight = randomSelectTwo() ? this.thinStroke : this.thickStroke
...
class DottedLines extends CrystalLayer {                           
  constructor () {
    super()
    this.numShapes = randomSelectTwo() ? this.sides : this.sides * 2
    this.angle = 360 / this.numShapes
...
class CenteredShape extends CrystalLayer {                     
  constructor () {
    super()
...
class RingOfShapes extends CrystalLayer {                    
  constructor () {
    super()
...
class SteppedHexagons extends CrystalLayer {                 
  constructor () {
    super()
